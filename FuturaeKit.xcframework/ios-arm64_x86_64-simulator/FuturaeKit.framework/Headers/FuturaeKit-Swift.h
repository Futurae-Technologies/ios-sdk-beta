...
@interface FTRClient (SWIFT_EXTENSION(FuturaeKit))
/// Retrieve notification body for arbitrary push notification
/// \param notificationId identifier of the arbitrary push notification.
///
...
/// Notifies the delegate that the notification data for an arbitrary push notification has been loaded.

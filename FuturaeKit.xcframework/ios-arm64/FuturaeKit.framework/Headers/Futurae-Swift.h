...
@class ApproveMobileAuth;
@class RejectMobileAuth;
...
/// Creates an <code>AuthReplyParameters</code> instance for a usernameless URI authentication reply.
/// \param reply The type of reply (<code>approve</code>, <code>reject</code>, or <code>fraud</code>).
///
/// \param sessionToken The session token for the authentication request.
///
/// \param userId The user identifier.
///
/// \param extraInfo Additional information as an array of <code>FTRExtraInfo</code>, optional.
...
/// returns:
/// An <code>AuthReplyParameters</code> instance corresponding to the specified reply type.
+ (AuthReplyParameters * _Nonnull)replyUsernamelessAuth:(enum AuthReplyType)reply sessionToken:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo SWIFT_WARN_UNUSED_RESULT;
...
/// Creates an <code>AuthReplyParameters</code> instance  for approving an authentication request using session token.
/// \param reply The type of reply (<code>approve</code>, <code>reject</code>, or <code>fraud</code>).
///
/// \param sessionToken The session token for the authentication request.
///
...
/// returns:
/// An <code>AuthReplyParameters</code> instance corresponding to the specified reply type.
+ (AuthReplyParameters * _Nonnull)replyMobileAuth:(enum AuthReplyType)reply sessionToken:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo SWIFT_WARN_UNUSED_RESULT;
...
/// Creates an instance for approving a usernameless authentication request.
/// \param sessionToken The session token string associated with the authentication request.
///
/// \param userId The user identifier.
///
/// \param extraInfo Additional information as an array of <code>FTRExtraInfo</code>, optional.
...
/// returns:
/// An instance of <code>ApproveAuthUsernameless</code> with the provided parameters.
+ (ApproveAuthUsernameless * _Nonnull)approveUsernamelessAuth:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo SWIFT_WARN_UNUSED_RESULT;
...
/// Creates an instance for approving an authentication request using session token.
/// \param sessionToken The session token for the authentication request.
///
/// \param userId The user identifier.
///
...
///
/// returns:
/// An instance of <code>ApproveMobileAuth</code> with the provided parameters.
+ (ApproveMobileAuth * _Nonnull)approveMobileAuthWithSessionToken:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo SWIFT_WARN_UNUSED_RESULT;
/// Creates an instance for rejecting an authentication request using session token.
/// \param sessionToken The session token for the authentication request.
///
/// \param userId The user identifier.
///
...
///
/// returns:
/// An instance of <code>RejectMobileAuth</code> with the provided parameters.
+ (RejectMobileAuth * _Nonnull)rejectMobileAuthWithSessionToken:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId isFraud:(BOOL)isFraud extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo SWIFT_WARN_UNUSED_RESULT;
...
/// Creates an instance for rejecting a usernameless authentication request.
/// \param sessionToken The session token string associated with the authentication request.
///
/// \param userId The user identifier.
///
...
/// returns:
/// An instance of <code>RejectAuthUsernameless</code> with the provided parameters.
+ (RejectAuthUsernameless * _Nonnull)rejectUsernamelessAuth:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId isFraud:(BOOL)isFraud extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo SWIFT_WARN_UNUSED_RESULT;
...
/// Initializes a new instance of <code>ApproveAuthUsernameless</code>.
/// \param qrCode The session token string associated with the authentication request.
///
/// \param userId The user identifier.
///
/// \param extraInfo Additional information as an array of <code>FTRExtraInfo</code>, optional.
///
- (nonnull instancetype)initWithSessionToken:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo OBJC_DESIGNATED_INITIALIZER;
@end

/// Represents parameters for approving an authentication using a session token.
SWIFT_CLASS("_TtC10FuturaeKit17ApproveMobileAuth")
@interface ApproveMobileAuth : AuthReplyParameters
/// Initializes a new instance of <code>ApproveMobileAuth</code>.
/// \param sessionToken The session token for the authentication request.
///
/// \param userId The user identifier.
///
/// \param extraInfo Additional information as an array of <code>FTRExtraInfo</code>, optional.
///
- (nonnull instancetype)init:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo OBJC_DESIGNATED_INITIALIZER;
@end
...
/// An array of <code>FTRFeatureFlag</code> objects, each indicating the status and details of a specific feature flag.
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSNumber *> * _Nonnull sdkFeatureFlags;
...
///
/// \param success A closure executed when attestation succeeds.
///
/// \param failure A closure executed when attestation fails, with an error describing the reason.
///
...
/// Retrieve generated logs from SDK operations
/// In order for logs to be generated FTRClient.enableLogging() needs to be called before SDK launch
///
/// returns:
/// A string that contains logs generated from SDK operations
+ (NSString * _Nullable)logsReport SWIFT_WARN_UNUSED_RESULT;
@end
...
@class IntegrityVerdictConfiguration;
...
@property (nonatomic, readonly, strong) IntegrityVerdictConfiguration * _Nullable integrityVerdictConfiguration;
...
///
/// \param teamID Apple team identifier needed for App Attest functionality.
///
...
/// Extracts usernameless authentication data from a given URL.
/// If the URL is an usernameless authentication URL, this method parses it to extract the session token.. Optionally, a redirect URI for mobile authentication may also be included.
/// \param url The authentication URL to parse.
///
///
/// returns:
/// An <code>UsernamelessURLData</code> object containing  a  session token, and optionally a mobile auth redirect URI, or <code>nil</code> if the URL is invalid or the required information is missing.
+ (UsernamelessURLData * _Nullable)usernamelessAuthDataFromURL:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
...
/// <code>IntegrityVerdictConfiguration</code> class represents the configuration settings for integrity verdict functionality.
SWIFT_CLASS("_TtC10FuturaeKit29IntegrityVerdictConfiguration")
@interface IntegrityVerdictConfiguration : NSObject
/// Indicates whether production will be used for integrity verdict
@property (nonatomic, readonly) BOOL production;
/// Team identifier of your Apple developer account.
@property (nonatomic, readonly, copy) NSString * _Nonnull teamID;
/// Sets the duration (in milliseconds) that the SDK will block authentication to retrieve an integrity verdict. Default value is 5000ms, minimum is 500ms.
@property (nonatomic, readonly, strong) NSNumber * _Nonnull blockingIVCollectionTimeoutOnAuthMillis;
/// Initializes a new <code>IntegrityVerdictConfiguration</code> with specified parameters.
/// \param teamID Team identifier of your Apple developer account.
///
/// \param production Indicates whether production will be used for integrity verdict
///
/// \param blockingIVCollectionTimeoutOnAuthMillis Sets the duration (in milliseconds) that the SDK will block authentication to retrieve an integrity verdict. Default value is 5000ms, minimum is 500ms.
///
- (nonnull instancetype)initWithTeamID:(NSString * _Nonnull)teamID production:(BOOL)production blockingIVCollectionTimeoutOnAuthMillis:(NSNumber * _Nullable)blockingIVCollectionTimeoutOnAuthMillis OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithSessionToken:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId isFraud:(BOOL)isFraud extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo OBJC_DESIGNATED_INITIALIZER;
@end

/// Represents parameters for rejecting an authentication request using a session token.
SWIFT_CLASS("_TtC10FuturaeKit16RejectMobileAuth")
@interface RejectMobileAuth : AuthReplyParameters
/// Initializes a new instance of <code>RejectMobileAuth</code>.
/// \param sessionToken The session token for the authentication request.
///
/// \param userId The user identifier.
///
...
/// \param extraInfo Additional information as an array of <code>FTRExtraInfo</code>, optional.
///
- (nonnull instancetype)init:(NSString * _Nonnull)sessionToken userId:(NSString * _Nonnull)userId isFraud:(BOOL)isFraud extraInfo:(NSArray<FTRExtraInfo *> * _Nullable)extraInfo OBJC_DESIGNATED_INITIALIZER;
@end
...
/// The  account  in the URL link could not be found.
  SDKURLErrorCodeAccountNotFound = 8,
};
...
SWIFT_CLASS("_TtC10FuturaeKit19UsernamelessURLData")
@interface UsernamelessURLData : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull sessionToken;
@property (nonatomic, readonly, copy) NSString * _Nullable mobileAuthRedirectUri;
- (nonnull instancetype)initWithSessionToken:(NSString * _Nonnull)sessionToken mobileAuthRedirectUri:(NSString * _Nullable)mobileAuthRedirectUri OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

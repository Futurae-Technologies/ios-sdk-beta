...
typedef SWIFT_ENUM(NSInteger, FTRAdaptivePermissionStatus, open) {
...
SWIFT_PROTOCOL("_TtP10FuturaeKit22FTRAdaptiveSDKDelegate_")
@protocol FTRAdaptiveSDKDelegate <NSObject>
- (enum FTRAdaptivePermissionStatus)bluetoothSettingStatus SWIFT_WARN_UNUSED_RESULT;
- (enum FTRAdaptivePermissionStatus)bluetoothPermissionStatus SWIFT_WARN_UNUSED_RESULT;
- (enum FTRAdaptivePermissionStatus)locationSettingStatus SWIFT_WARN_UNUSED_RESULT;
- (enum FTRAdaptivePermissionStatus)locationPermissionStatus SWIFT_WARN_UNUSED_RESULT;
- (enum FTRAdaptivePermissionStatus)locationPrecisePermissionStatus SWIFT_WARN_UNUSED_RESULT;
- (enum FTRAdaptivePermissionStatus)networkSettingStatus SWIFT_WARN_UNUSED_RESULT;
- (enum FTRAdaptivePermissionStatus)networkPermissionStatus SWIFT_WARN_UNUSED_RESULT;
@optional
...
- (NSArray<NSDictionary<NSString *, id> *> * _Nullable)decryptExtraInfo:(NSString * _Nonnull)encryptedExtraInfo userId:(NSString * _Nonnull)userId error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface FTRClient (SWIFT_EXTENSION(FuturaeKit)) <AdaptiveSDKDelegate>
- (void)didReceiveUpdateWithCollectedData:(NSDictionary<NSString *, id> * _Nonnull)collectedData;
...
/// Enumerates the possible configuration statuses for the SDK’s lock mechanism.
typedef SWIFT_ENUM(NSInteger, SDKLockConfigStatus, open) {
...
/// The current configuration status of the lock.
@property (nonatomic, readonly) enum SDKLockConfigStatus configStatus;
